# openair-cn-cups
Control User Plane Separation for BNG based on PFCP, using the provided PFCP stack
within the OAI Control User Plane Separation of SPGW-C and SPGW-U project.
...
├── build :       Build directory, contains targets and object files generated by compilation of network functions.
    ├── bngc :    Directory containing CMakefile.txt and object files generated by compilation of BNG-C network function.
    ├── bngu :    Directory containing CMakefile.txt and object files generated by compilation of BNG-U network function.
...
└── src :         Source files of network functions.
    ├── bng :    BNG files
    │   ├── bngc :  BNG control plane functions
    │   └── bngu :  BNG user plane functions
    ...
    ├── spgwu :     Telnet client implementation
