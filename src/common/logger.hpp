...
public:
   ...
   static _Logger &bngc_app() { return *singleton().m_bngc_app; }
   static _Logger &bngc_pfcp() { return *singleton().m_bngc_pfcp; }
   static _Logger &bngu_app() { return *singleton().m_bngu_app; }
   static _Logger &bngu_pfcp() { return *singleton().m_bngu_pfcp; }
