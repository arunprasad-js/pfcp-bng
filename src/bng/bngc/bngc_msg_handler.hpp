...
#define PPPD_CTRL_IFTYPE "ctrl_type"
#define PPPD_DHCP_SESSIONID "xid"
#define PPPD_SESSIONID "session_id"
...
int generate_downstream_pdr_ie(pfcp::create_pdr *create_pdr,
