...
public:
  ...
  pfcp_tlv(uint16_t t, uint16_t l = 0, uint16_t e = 0) : type(t), length(l), enterprise_id(e) {}
...
public:
  ...
  explicit pfcp_ie(const uint16_t tlv_type) : tlv() {
    tlv.type = tlv_type;
  }

  virtual ~pfcp_ie() {};

  virtual void to_core_type(pfcp_ies_container& s) {throw pfcp_msg_illegal_ie_exception(s.msg_id, tlv.type, __FILE__, __LINE__);}
  ...
  virtual void load_from(std::istream& is) {
    ...
    while (remaining_size > 0) {
      ...
      if (ie) {
        ...
        throw pfcp_tlv_bad_length_exception(tlv.get_type(), tlv.get_length(), __FILE__, __LINE__);
      }
    }
  };
};
...
public:
  ...
  pfcp_msg_header() : message_type(0), message_length(3 + 1), seid(0), sequence_number(0), u1(), u2()
  {
    u1.bf.version = 1;
  }
...
public:
  ...
  pfcp_msg() : pfcp_msg_header(), remote_port(0) {
    ies = {};
  }

  pfcp_msg(const pfcp_msg& m) : pfcp_msg_header(m), remote_port(m.remote_port), ies(m.ies) {}

  explicit pfcp_msg(const pfcp_msg_header& hdr) : pfcp_msg_header(hdr), remote_port(0) {
    ies = {};
  }
...
//  pfcp_msg(const pfcp_node_report_response& pfcp_ies);
  ...
  void load_from(std::istream& is) {
    ...
    if (ies_length != check_msg_length) {
      ...
      throw pfcp_msg_bad_length_exception(get_message_type(), get_message_length(), ies_length, check_msg_length, __FILE__, __LINE__);
    }
  }
};
...
public:
  ...
  //--------
  void to_core_type(pfcp::cause_t& b) {
...
public:
  ...
  //--------
  explicit pfcp_source_interface_ie(const pfcp::source_interface_t& b) : pfcp_ie(PFCP_IE_SOURCE_INTERFACE){
...
public:
  ...
  //--------
  explicit pfcp_network_instance_ie(const pfcp::network_instance_t& b) : pfcp_ie(PFCP_IE_NETWORK_INSTANCE){
...
public:
  ...
  //--------
  explicit pfcp_sdf_filter_ie(const pfcp::sdf_filter_t& b) : pfcp_ie(PFCP_IE_SDF_FILTER){
    tlv.set_length(2);
    u1.b = 0;
...
public:
  ...
  //--------
  explicit pfcp_application_id_ie(const pfcp::application_id_t& b) : pfcp_ie(PFCP_IE_APPLICATION_ID){
...
public:
  ...
  //--------
  explicit pfcp_gate_status_ie(const pfcp::gate_status_t& b) : pfcp_ie(PFCP_IE_GATE_STATUS){
    u1.b = 0;
...
public:
  ...
  //--------
  explicit pfcp_qer_correlation_id_ie(const pfcp::qer_correlation_id_t& b) : pfcp_ie(PFCP_IE_QER_CORRELATION_ID){
...
public:
  ...
  //--------
  explicit pfcp_precedence_ie(const pfcp::precedence_t& b) : pfcp_ie(PFCP_IE_PRECEDENCE){
  ...
  //--------
  void to_core_type(pfcp::precedence_t& b) {
...
public:
  ...
  //--------
  explicit pfcp_transport_level_marking_ie(const pfcp::transport_level_marking_t& b) : pfcp_ie(PFCP_IE_TRANSPORT_LEVEL_MARKING){
...
public:
  ...
  //--------
  explicit pfcp_volume_threshold_ie(const pfcp::volume_threshold_t& b) : pfcp_ie(PFCP_IE_VOLUME_THRESHOLD){
    tlv.set_length(1);
    u1.b = 0;
    u1.bf.tovol = b.tovol;
    u1.bf.ulvol = b.ulvol;
...
public:
  ...
  //--------
  explicit pfcp_time_threshold_ie(const pfcp::time_threshold_t& b) : pfcp_ie(PFCP_IE_TIME_THRESHOLD){
    time_threshold = b.time_threshold;
    tlv.set_length(sizeof(time_threshold));
  }
  //--------
  pfcp_time_threshold_ie() : pfcp_ie(PFCP_IE_TIME_THRESHOLD), time_threshold(0) {
    tlv.set_length(sizeof(time_threshold));
  }
  //--------
  explicit pfcp_time_threshold_ie(const pfcp_tlv& t) : pfcp_ie(t), time_threshold(0) {};
  //--------
...
public:
  ...
  //--------
  explicit pfcp_monitoring_time_ie(const pfcp::monitoring_time_t& b) : pfcp_ie(PFCP_IE_MONITORING_TIME){
    monitoring_time = b.monitoring_time;
    tlv.set_length(sizeof(monitoring_time));
  }
  //--------
  pfcp_monitoring_time_ie() : pfcp_ie(PFCP_IE_MONITORING_TIME), monitoring_time(0){
    tlv.set_length(sizeof(monitoring_time));
  }
  //--------
  explicit pfcp_monitoring_time_ie(const pfcp_tlv& t) : pfcp_ie(t), monitoring_time(0) {};
  //--------
...
public:
  ...
  uint64_t downlink_volume;
  //--------
  explicit pfcp_subsequent_volume_threshold_ie(const pfcp::subsequent_volume_threshold_t& b) : pfcp_ie(PFCP_IE_SUBSEQUENT_VOLUME_THRESHOLD){
    tlv.set_length(1);
    u1.b = 0;
    u1.bf.tovol = b.tovol;
    u1.bf.ulvol = b.ulvol;
  ...
  //--------
  explicit pfcp_subsequent_volume_threshold_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
...
public:
  ...
  //--------
  explicit pfcp_subsequent_time_threshold_ie(const pfcp::subsequent_time_threshold_t& b) : pfcp_ie(PFCP_IE_SUBSEQUENT_TIME_THRESHOLD){
    subsequent_time_threshold = b.subsequent_time_threshold;
    tlv.set_length(sizeof(subsequent_time_threshold));
  }
  //--------
  pfcp_subsequent_time_threshold_ie() : pfcp_ie(PFCP_IE_SUBSEQUENT_TIME_THRESHOLD), subsequent_time_threshold(0) {
    tlv.set_length(sizeof(subsequent_time_threshold));
  }
  //--------
  explicit pfcp_subsequent_time_threshold_ie(const pfcp_tlv& t) : pfcp_ie(t), subsequent_time_threshold(0) {};
  //--------
...
public:
  ...
  //--------
  explicit pfcp_inactivity_detection_time_ie(const pfcp::inactivity_detection_time_t& b) : pfcp_ie(PFCP_IE_INACTIVITY_DETECTION_TIME){
    inactivity_detection_time = b.inactivity_detection_time;
    tlv.set_length(sizeof(inactivity_detection_time));
  }
  //--------
  pfcp_inactivity_detection_time_ie() : pfcp_ie(PFCP_IE_INACTIVITY_DETECTION_TIME), inactivity_detection_time(0) {
    tlv.set_length(sizeof(inactivity_detection_time));
  }
  //--------
  explicit pfcp_inactivity_detection_time_ie(const pfcp_tlv& t) : pfcp_ie(t), inactivity_detection_time(0) {};
  //--------
...
public:
  ...
  //--------
  explicit pfcp_reporting_triggers_ie(const pfcp::reporting_triggers_t& b) : pfcp_ie(PFCP_IE_REPORTING_TRIGGERS){
    u1.b = 0;
    u2.b = 0;
    tlv.set_length(2);
    u1.bf.liusa = b.liusa;
...
//  std::string
//  //--------
//  pfcp_redirect_information_ie(const pfcp::redirect_information_t& b) : pfcp_ie(PFCP_IE_REDIRECT_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_offending_ie_ie(const pfcp::offending_ie_t& b) : pfcp_ie(PFCP_IE_OFFENDING_IE){
  ...
  void dump_to(std::ostream& os) {
    ...
    os.write(reinterpret_cast<const char*>(&be_type_of_the_offending_ie), sizeof(be_type_of_the_offending_ie));
  }
  //--------
  void load_from(std::istream& is) {
    //tlv.load_from(is);
...
public:
  ...
  //--------
  explicit pfcp_forwarding_policy_ie(const pfcp::forwarding_policy_t& b) : pfcp_ie(PFCP_IE_FORWARDING_POLICY){
  ...
  //--------
  explicit pfcp_forwarding_policy_ie(const pfcp_tlv& t) : pfcp_ie(t), forwarding_policy_identifier_length(0), forwarding_policy_identifier() {};
  //--------
...
public:
  ...
  //--------
  explicit pfcp_destination_interface_ie(const pfcp::destination_interface_t& b) : pfcp_ie(PFCP_IE_DESTINATION_INTERFACE){
    interface_value = b.interface_value;
    tlv.set_length(1);
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_up_function_features_ie(const pfcp::up_function_features_s& b) : pfcp_ie(PFCP_IE_UP_FUNCTION_FEATURES){
    u1.b = 0;
    u2.b = 0;
    u1.bf.bucp = b.bucp;
    u1.bf.ddnd = b.ddnd;
...
public:
  ...
  //--------
  explicit pfcp_apply_action_ie(const pfcp::apply_action_t& b) : pfcp_ie(PFCP_IE_APPLY_ACTION){
    tlv.set_length(1);
    u1.b = 0;
    u1.bf.drop = b.drop;
    u1.bf.forw = b.forw;
...
//
//  //--------
//  pfcp_downlink_data_service_information_ie(const pfcp::downlink_data_service_information_t& b) : pfcp_ie(PFCP_IE_DOWNLINK_DATA_SERVICE_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::downlink_data_service_information_t downlink_data_service_information = {};
...
//
//  //--------
//  pfcp_downlink_data_notification_delay_ie(const pfcp::downlink_data_notification_delay_t& b) : pfcp_ie(PFCP_IE_DOWNLINK_DATA_NOTIFICATION_DELAY){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::downlink_data_notification_delay_t downlink_data_notification_delay = {};
...
//
//  //--------
//  pfcp_dl_buffering_duration_ie(const pfcp::dl_buffering_duration_t& b) : pfcp_ie(PFCP_IE_DL_BUFFERING_DURATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_dl_buffering_suggested_packet_count_ie(const pfcp::dl_buffering_suggested_packet_count_t& b) : pfcp_ie(PFCP_IE_DL_BUFFERING_SUGGESTED_PACKET_COUNT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::dl_buffering_suggested_packet_count_t dl_buffering_suggested_packet_count = {};
...
//
//  //--------
//  pfcp_pfcpsmreq_flags_ie(const pfcp::pfcpsmreq_flags_t& b) : pfcp_ie(PFCP_IE_PFCPSMREQ_FLAGS){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_pfcpsrrsp_flags_ie(const pfcp::pfcpsrrsp_flags_t& b) : pfcp_ie(PFCP_IE_PFCPSRRSP_FLAGS){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_load_control_information_ie(const pfcp::load_control_information& b) : pfcp_ie(PFCP_IE_LOAD_CONTROL_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_sequence_number_ie(const pfcp::sequence_number_t& b) : pfcp_ie(PFCP_IE_SEQUENCE_NUMBER){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_overload_control_information_ie(const pfcp::overload_control_information& b) : pfcp_ie(PFCP_IE_OVERLOAD_CONTROL_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_pdr_id_ie(const pfcp::pdr_id_t& b) : pfcp_ie(PFCP_IE_PACKET_DETECTION_RULE_ID){
    rule_id = b.rule_id;
  ...
  //--------
  void to_core_type(pfcp::pdr_id_t& b) {
    b.rule_id = rule_id;
  }
  //--------
  void dump_to(std::ostream& os) {
...
//
//  //--------
//  pfcp_application_ids_pfds_ie(const pfcp::application_ids_pfds& b) : pfcp_ie(PFCP_IE_APPLICATION_IDS_PFDS){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_node_id_ie(const pfcp::node_id_t& b) : pfcp_ie(PFCP_IE_NODE_ID){
    u1.b = 0;
    tlv.set_length(1);
    ipv4_address.s_addr = INADDR_ANY;
    ipv6_address = in6addr_any;
...
//
//  //--------
//  pfcp_pfd_contents_ie(const pfcp::pfd_contents_t& b) : pfcp_ie(PFCP_IE_PFD_CONTENTS){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_measurement_method_ie(const pfcp::measurement_method_t& b) : pfcp_ie(PFCP_IE_MEASUREMENT_METHOD){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_usage_report_trigger_ie(const pfcp::usage_report_trigger_t& b) : pfcp_ie(PFCP_IE_USAGE_REPORT_TRIGGER){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_measurement_period_ie(const pfcp::measurement_period_t& b) : pfcp_ie(PFCP_IE_MEASUREMENT_PERIOD){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_volume_measurement_ie(const pfcp::volume_measurement_t& b) : pfcp_ie(PFCP_IE_VOLUME_MEASUREMENT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_duration_measurement_ie(const pfcp::duration_measurement_t& b) : pfcp_ie(PFCP_IE_DURATION_MEASUREMENT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_application_detection_information_ie(const pfcp::application_detection_information& b) : pfcp_ie(PFCP_IE_APPLICATION_DETECTION_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::application_detection_information application_detection_information = {};
...
//
//  //--------
//  pfcp_time_of_first_packet_ie(const pfcp::time_of_first_packet_t& b) : pfcp_ie(PFCP_IE_TIME_OF_FIRST_PACKET){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_time_of_last_packet_ie(const pfcp::time_of_last_packet_t& b) : pfcp_ie(PFCP_IE_TIME_OF_LAST_PACKET){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_quota_holding_time_ie(const pfcp::quota_holding_time_t& b) : pfcp_ie(PFCP_IE_QUOTA_HOLDING_TIME){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_dropped_dl_traffic_threshold_ie(const pfcp::dropped_dl_traffic_threshold_t& b) : pfcp_ie(PFCP_IE_DROPPED_DL_TRAFFIC_THRESHOLD){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_volume_quota_ie(const pfcp::volume_quota_t& b) : pfcp_ie(PFCP_IE_VOLUME_QUOTA){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_time_quota_ie(const pfcp::time_quota_t& b) : pfcp_ie(PFCP_IE_TIME_QUOTA){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_start_time_ie(const pfcp::start_time_t& b) : pfcp_ie(PFCP_IE_START_TIME){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_usage_report_within_session_modification_response_ie(const pfcp::usage_report_within_pfcp_session_modification_response& b) : pfcp_ie(PFCP_IE_USAGE_REPORT_WITHIN_SESSION_MODIFICATION_RESPONSE){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  };
//  //--------
//  void to_core_type(pfcp::usage_report_within_pfcp_session_modification_response& b) {
//    b.todo = todo;
//  }
//  //--------
//  void dump_to(std::ostream& os) {
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::usage_report_within_pfcp_session_modification_response usage_report_within_session_modification_response = {};
...
//
//  //--------
//  pfcp_usage_report_within_session_deletion_response_ie(const pfcp::usage_report_within_pfcp_session_deletion_response& b) : pfcp_ie(PFCP_IE_USAGE_REPORT_WITHIN_SESSION_DELETION_RESPONSE){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  };
//  //--------
//  void to_core_type(pfcp::usage_report_within_pfcp_session_deletion_response& b) {
//    b.todo = todo;
//  }
//  //--------
//  void dump_to(std::ostream& os) {
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::usage_report_within_pfcp_session_deletion_response usage_report_within_session_deletion_response = {};
...
//
//  //--------
//  pfcp_usage_report_within_session_report_request_ie(const pfcp::usage_report_within_pfcp_session_report_request& b) : pfcp_ie(PFCP_IE_USAGE_REPORT_WITHIN_SESSION_REPORT_REQUEST){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::usage_report_within_pfcp_session_report_request usage_report_within_session_report_request = {};
...
//
//  //--------
//  pfcp_linked_urr_id_ie(const pfcp::linked_urr_id_t& b) : pfcp_ie(PFCP_IE_LINKED_URR_ID){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_outer_header_creation_ie(const pfcp::outer_header_creation_t& b) : pfcp_ie(PFCP_IE_OUTER_HEADER_CREATION){
    teid = {};
    ipv4_address = {};
    ipv6_address = {};
    port_number = {};
    ...
    if (outer_header_creation_description & (pfcp::OUTER_HEADER_CREATION_GTPU_UDP_IPV4 |pfcp:: OUTER_HEADER_CREATION_GTPU_UDP_IPV6)) {
      teid = b.teid;
      tlv.add_length(sizeof(teid));
    }
    if (outer_header_creation_description & (pfcp::OUTER_HEADER_CREATION_GTPU_UDP_IPV4 | pfcp::OUTER_HEADER_CREATION_UDP_IPV4)) {
      ipv4_address = b.ipv4_address;
      tlv.add_length(sizeof(ipv4_address.s_addr));
    }
    if (outer_header_creation_description & (pfcp::OUTER_HEADER_CREATION_GTPU_UDP_IPV6 | pfcp::OUTER_HEADER_CREATION_UDP_IPV6)) {
      ipv6_address = b.ipv6_address;
      tlv.add_length(sizeof(ipv6_address.s6_addr));
    }
    if (outer_header_creation_description & pfcp::OUTER_HEADER_CREATION_UDP_IPV4) {
...
//
//  //--------
//  pfcp_update_bar_within_session_modification_request_ie(const pfcp::update_bar_within_pfcp_session_modification_request& b) : pfcp_grouped_ie(PFCP_IE_UPDATE_BAR_WITHIN_PFCP_SESSION_MODIFICATION_REQUEST){
//    tlv.set_length(0);
//  }
//  //--------
...
//  }
//  //--------
//  void to_core_type(pfcp::update_bar_within_pfcp_session_modification_request& c) {
//    for (auto sie : ies) {
//      sie.get()->to_core_type(c);
//    }
//  }
...
public:
  ...
  //--------
  explicit pfcp_bar_id_ie(const pfcp_tlv& t) : pfcp_ie(t) {
    bar_id = 0;
  };
  //--------
  void to_core_type(pfcp::bar_id_t& b) {
    b.bar_id = bar_id;
  }
  //--------
  void dump_to(std::ostream& os) {
...
public:
  ...
  //--------
  explicit pfcp_cp_function_features_ie(const pfcp::cp_function_features_t& b) : pfcp_ie(PFCP_IE_CP_FUNCTION_FEATURES){
    u1.b = 0;
    u1.bf.load = b.load;
    u1.bf.ovrl = b.ovrl;
    tlv.set_length(1);
...
//
//  //--------
//  pfcp_usage_information_ie(const pfcp::usage_information_t& b) : pfcp_ie(PFCP_IE_USAGE_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_application_instance_id_ie(const pfcp::application_instance_id_t& b) : pfcp_ie(PFCP_IE_APPLICATION_INSTANCE_ID){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_flow_information_ie(const pfcp::flow_information_t& b) : pfcp_ie(PFCP_IE_FLOW_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_ue_ip_address_ie(const pfcp::ue_ip_address_t& b) : pfcp_ie(PFCP_IE_UE_IP_ADDRESS){
    u1.b = 0;
    ipv4_address.s_addr = INADDR_ANY;
    ipv6_address = in6addr_any;
...
//
//  //--------
//  pfcp_packet_rate_ie(const pfcp::packet_rate_t& b) : pfcp_ie(PFCP_IE_PACKET_RATE){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_outer_header_removal_ie(const pfcp::outer_header_removal_t& b) : pfcp_ie(PFCP_IE_OUTER_HEADER_REMOVAL){
...
public:
  ...
  //--------
  explicit pfcp_recovery_time_stamp_ie(const pfcp::recovery_time_stamp_t& b) : pfcp_ie(PFCP_IE_RECOVERY_TIME_STAMP){
...
//
//  //--------
//  pfcp_dl_flow_level_marking_ie(const pfcp::dl_flow_level_marking_t& b) : pfcp_ie(PFCP_IE_DL_FLOW_LEVEL_MARKING){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_header_enrichment_ie(const pfcp::header_enrichment_t& b) : pfcp_ie(PFCP_IE_HEADER_ENRICHMENT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_error_indication_report_ie(const pfcp::error_indication_report& b) : pfcp_ie(PFCP_IE_ERROR_INDICATION_REPORT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_measurement_information_ie(const pfcp::measurement_information_t& b) : pfcp_ie(PFCP_IE_MEASUREMENT_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_user_plane_path_failure_report_ie(const pfcp::user_plane_path_failure_report& b) : pfcp_ie(PFCP_IE_USER_PLANE_PATH_FAILURE_REPORT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_remote_gtp_u_peer_ie(const pfcp::remote_gtp_u_peer_t& b) : pfcp_ie(PFCP_IE_REMOTE_GTP_U_PEER){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_update_duplicating_parameters_ie(const pfcp::update_duplicating_parameters& b) : pfcp_ie(PFCP_IE_UPDATE_DUPLICATING_PARAMETERS){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_activate_predefined_rules_ie(const pfcp::activate_predefined_rules_t& b) : pfcp_ie(PFCP_IE_ACTIVATE_PREDEFINED_RULES){
...
public:
  ...
  //--------
  explicit pfcp_deactivate_predefined_rules_ie(const pfcp::deactivate_predefined_rules_t& b) : pfcp_ie(PFCP_IE_DEACTIVATE_PREDEFINED_RULES){
    predefined_rules_name = b.predefined_rules_name;
    tlv.set_length(predefined_rules_name.size());
  }
  //--------
  ...
  //--------
  explicit pfcp_deactivate_predefined_rules_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
...
//
//  //--------
//  pfcp_pfcp_association_release_request_ie(const pfcp::pfcp_association_release_request_t& b) : pfcp_ie(PFCP_IE_PFCP_ASSOCIATION_RELEASE_REQUEST){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::pfcp_association_release_request_t pfcp_association_release_request = {};
...
//
//  //--------
//  pfcp_graceful_release_period_ie(const pfcp::graceful_release_period_t& b) : pfcp_ie(PFCP_IE_GRACEFUL_RELEASE_PERIOD){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_failed_rule_id_ie(const pfcp::failed_rule_id_t& b) : pfcp_ie(PFCP_IE_FAILED_RULE_ID){
    u1.b = 0;
...
//
//  //--------
//  pfcp_time_quota_mechanism_ie(const pfcp::time_quota_mechanism_t& b) : pfcp_ie(PFCP_IE_TIME_QUOTA_MECHANISM){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_user_plane_ip_resource_information_ie(const pfcp::user_plane_ip_resource_information_t& b) : pfcp_ie(PFCP_IE_USER_PLANE_IP_RESOURCE_INFORMATION){
    u1.b = 0;
    u2.b = 0;
    teid_range = 0;
    ipv4_address.s_addr = INADDR_ANY;
  ...
  //--------
  explicit pfcp_user_plane_ip_resource_information_ie(const pfcp_tlv& t) : pfcp_ie(t) {
    u1.b = 0;
    u2.b = 0;
    teid_range = 0;
    ipv4_address.s_addr = INADDR_ANY;
...
public:
  ...
  //--------
  explicit pfcp_user_plane_inactivity_timer_ie(const pfcp::user_plane_inactivity_timer_t& b) : pfcp_ie(PFCP_IE_USER_PLANE_INACTIVITY_TIMER){
...
//
//  //--------
//  pfcp_aggregated_urrs_ie(const pfcp::aggregated_urrs& b) : pfcp_ie(PFCP_IE_AGGREGATED_URRS){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_multiplier_ie(const pfcp::multiplier_t& b) : pfcp_ie(PFCP_IE_MULTIPLIER){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_aggregated_urr_id_ie(const pfcp::aggregated_urr_id_t& b) : pfcp_ie(PFCP_IE_AGGREGATED_URR_ID){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_subsequent_volume_quota_ie(const pfcp::subsequent_volume_quota_t& b) : pfcp_ie(PFCP_IE_SUBSEQUENT_VOLUME_QUOTA){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_subsequent_time_quota_ie(const pfcp::subsequent_time_quota_t& b) : pfcp_ie(PFCP_IE_SUBSEQUENT_TIME_QUOTA){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  void to_core_type(pfcp::qfi_t& b) {
    b.qfi = u1.bf.qfi;
  }
  //--------
  void dump_to(std::ostream& os) {
...
//
//  //--------
//  pfcp_query_urr_reference_ie(const pfcp::query_urr_reference_t& b) : pfcp_ie(PFCP_IE_QUERY_URR_REFERENCE){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_additional_usage_reports_information_ie(const pfcp::additional_usage_reports_information_t& b) : pfcp_ie(PFCP_IE_ADDITIONAL_USAGE_REPORTS_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::additional_usage_reports_information_t additional_usage_reports_information = {};
...
//
//  //--------
//  pfcp_create_traffic_endpoint_ie(const pfcp::create_traffic_endpoint& b) : pfcp_ie(PFCP_IE_CREATE_TRAFFIC_ENDPOINT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_created_traffic_endpoint_ie(const pfcp::created_traffic_endpoint& b) : pfcp_ie(PFCP_IE_CREATED_TRAFFIC_ENDPOINT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_update_traffic_endpoint_ie(const pfcp::update_traffic_endpoint& b) : pfcp_ie(PFCP_IE_UPDATE_TRAFFIC_ENDPOINT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_remove_traffic_endpoint_ie(const pfcp::remove_traffic_endpoint& b) : pfcp_ie(PFCP_IE_REMOVE_TRAFFIC_ENDPOINT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_traffic_endpoint_id_ie(const pfcp::traffic_endpoint_id_t& b) : pfcp_ie(PFCP_IE_TRAFFIC_ENDPOINT_ID){
    traffic_endpoint_id = b.traffic_endpoint_id;
    tlv.set_length(1);
  }
  //--------
  pfcp_traffic_endpoint_id_ie() : pfcp_ie(PFCP_IE_TRAFFIC_ENDPOINT_ID){
    traffic_endpoint_id = 0;
    tlv.set_length(1);
  }
  //--------
  explicit pfcp_traffic_endpoint_id_ie(const pfcp_tlv& t) : pfcp_ie(t) {
    traffic_endpoint_id = 0;
  };
  //--------
  void to_core_type(pfcp::traffic_endpoint_id_t& b) {
    b.traffic_endpoint_id = traffic_endpoint_id;
  }
  //--------
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
    os.write(reinterpret_cast<const char*>(&traffic_endpoint_id), sizeof(traffic_endpoint_id));
  }
  //--------
  void load_from(std::istream& is) {
    //tlv.load_from(is);
    ...
    is.read(reinterpret_cast<char*>(&traffic_endpoint_id), sizeof(traffic_endpoint_id));
  }
  //--------
  void to_core_type(pfcp_ies_container& s) {
...
public:
  ...
  //--------
  explicit pfcp_mac_address_ie(const pfcp::mac_address_t& b) : pfcp_ie(PFCP_IE_MAC_ADDRESS){
    int i;
    u1.b = 0;
    ...
    if (u1.bf.dest) {
      for(i=0; i<6; i++) {
        destination_mac_address[i] = b.destination_mac_address[i];
      }
      tlv.add_length(6);
    }
    if (u1.bf.sour) {
      for(i=0; i<6; i++) {
        source_mac_address[i] = b.source_mac_address[i];
      }
      tlv.add_length(6);
    }
    if (u1.bf.udes) {
      for(i=0; i<6; i++) {
        destination_mac_address[i] = b.destination_mac_address[i];
        upper_destination_mac_address[i] = b.upper_destination_mac_address[i];
      }
      tlv.add_length(12);
    }
    if (u1.bf.usou) {
      for(i=0; i<6; i++) {
        source_mac_address[i] = b.source_mac_address[i];
        upper_source_mac_address[i] = b.upper_source_mac_address[i];
      }
      tlv.add_length(12);
    }
  }
  ...
  pfcp_mac_address_ie() : pfcp_ie(PFCP_IE_MAC_ADDRESS){
    u1.b = 0;
    for(int i=0; i<6; i++) {
      source_mac_address[i]=0;
      destination_mac_address[i]=0;
      upper_source_mac_address[i]=0;
      upper_destination_mac_address[i]=0;
    }
    tlv.set_length(1);
  }
  //--------
  ...
  void to_core_type(pfcp::mac_address_t& b) {
    ...
    if (u1.bf.dest) {
      for(i=0; i<6; i++) {
        b.destination_mac_address[i] = destination_mac_address[i];
      }
    }
    if (u1.bf.sour) {
      for(i=0; i<6; i++) {
        b.source_mac_address[i] = source_mac_address[i];
      }
    }
    if (u1.bf.udes) {
      for(i=0; i<6; i++) {
        b.destination_mac_address[i] = destination_mac_address[i];
        b.upper_destination_mac_address[i] = upper_destination_mac_address[i];
      }
    }
    if (u1.bf.usou) {
      for(i=0; i<6; i++) {
        b.source_mac_address[i] = source_mac_address[i];
        b.upper_source_mac_address[i] = upper_source_mac_address[i];
      }
    }
  }
  //--------
  void dump_to(std::ostream& os) {
    ...
    os.write(reinterpret_cast<const char*>(&u1.b), sizeof(u1.b));
    if (u1.bf.dest) {
      os.write(reinterpret_cast<const char*>(destination_mac_address), 6);
    }
    if (u1.bf.sour) {
      os.write(reinterpret_cast<const char*>(source_mac_address), 6);
    }
    if (u1.bf.udes) {
      os.write(reinterpret_cast<const char*>(destination_mac_address), 6);
      os.write(reinterpret_cast<const char*>(upper_destination_mac_address), 6);
    }
    if (u1.bf.usou) {
      os.write(reinterpret_cast<const char*>(source_mac_address), 6);
      os.write(reinterpret_cast<const char*>(upper_source_mac_address), 6);
    }
  }
  //--------
  void load_from(std::istream& is) {
    ...
    if (u1.bf.dest) {
      is.read(reinterpret_cast<char*>(destination_mac_address), 6);
    }
    if (u1.bf.sour) {
      is.read(reinterpret_cast<char*>(source_mac_address), 6);
    }
    if (u1.bf.udes) {
      is.read(reinterpret_cast<char*>(destination_mac_address), 6);
      is.read(reinterpret_cast<char*>(upper_destination_mac_address), 6);
    }
    if (u1.bf.usou) {
      is.read(reinterpret_cast<char*>(source_mac_address), 6);
      is.read(reinterpret_cast<char*>(upper_source_mac_address), 6);
    }
...
public:
  ...
  //--------
  explicit pfcp_c_tag_ie(const pfcp::c_tag_t& b) : pfcp_ie(PFCP_IE_C_TAG){
    u1.b = 0;
    ...
    if(b.vid) {
      tlv.add_length(2);
      cvid_value = b.cvid_value;
    } else if(b.pcp || b.dei) {
      tlv.add_length(1);
    }

    if(b.pcp) {
      pcp_value = b.pcp_value;
    }
  ...
  //--------
  explicit pfcp_c_tag_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
  void to_core_type(pfcp::c_tag_t& b) {
    ...
    b.vid = u1.bf.vid;
    if(u1.bf.pcp) {
      b.pcp_value = pcp_value;
    }
    if(u1.bf.dei) {
      b.dei_flag = dei_flag;
    }
    if(u1.bf.vid) {
      b.cvid_value = cvid_value;
    }
  }
  //--------
  void dump_to(std::ostream& os) {
    ...
    if(u1.bf.vid) {
      b2[1] = cvid_value & 0xFF;
      b2[0] = b2[0] | (((cvid_value >> 8) & 0xF) << 4);
    }
    if(u1.bf.pcp) {
      b2[0] = b2[0] | (pcp_value & 0x7);
    }
    if(u1.bf.dei) {
      b2[0] = b2[0] | (dei_flag << 3);
    }

    if(u1.bf.vid) {
      os.write(reinterpret_cast<const char*>(b2), 2);
    } else if(u1.bf.pcp || u1.bf.dei) {
  ...
  void load_from(std::istream& is) {
    ...
    uint8_t b2[2];
    if(u1.bf.vid) {
      is.read(reinterpret_cast<char*>(b2), 2);
      cvid_value = (((uint16_t)(b2[0] & 0xF0)) << 4) | b2[1];
    } else if(u1.bf.pcp || u1.bf.dei) {
...
public:
  ...
  //--------
  explicit pfcp_s_tag_ie(const pfcp::s_tag_t& b) : pfcp_ie(PFCP_IE_S_TAG){
    u1.b = 0;
  ...
  //--------
  explicit pfcp_s_tag_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
  ...
  void dump_to(std::ostream& os) {
    ...
    if(u1.bf.vid) {
      b2[1] = svid_value & 0xFF;
      b2[0] = b2[0] | (((svid_value >> 8) & 0xF) << 4);
    }
    if(u1.bf.pcp) {
      b2[0] = b2[0] | (pcp_value & 0x7);
    }
  ...
  void load_from(std::istream& is) {
    ...
    if(u1.bf.vid) {
      is.read(reinterpret_cast<char*>(b2), 2);
      svid_value = (((uint16_t)(b2[0] & 0xF0)) << 4) | b2[1];
    } else if(u1.bf.pcp || u1.bf.dei) {
      is.read(reinterpret_cast<char*>(b2), 1);
    }
...
//
//  //--------
//  pfcp_ethernet_filter_id_ie(const pfcp::ethernet_filter_id_t& b) : pfcp_ie(PFCP_IE_ETHERNET_FILTER_ID){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_ethernet_filter_properties_ie(const pfcp::ethernet_filter_properties_t& b) : pfcp_ie(PFCP_IE_ETHERNET_FILTER_PROPERTIES){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_suggested_buffering_packets_count_ie(const pfcp::suggested_buffering_packets_count_t& b) : pfcp_ie(PFCP_IE_SUGGESTED_BUFFERING_PACKETS_COUNT){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//  //--------
//  void to_core_type(pfcp_ies_container& s) {
//      pfcp::suggested_buffering_packets_count_t suggested_buffering_packets_count = {};
...
public:
  ...
  //--------
  explicit pfcp_user_id_ie(const pfcp::user_id_t& b) : pfcp_ie(PFCP_IE_USER_ID){
    u1.b = 0;
    length_of_imsi = 0;
    length_of_imei = 0;
    length_of_msisdn = 0;
...
//
//  //--------
//  pfcp_ethernet_pdu_session_information_ie(const pfcp::ethernet_pdu_session_information_t& b) : pfcp_ie(PFCP_IE_ETHERNET_PDU_SESSION_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_ethernet_traffic_information_ie(const pfcp::ethernet_traffic_information& b) : pfcp_ie(PFCP_IE_ETHERNET_TRAFFIC_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_mac_addresses_detected_ie(const pfcp::mac_addresses_detected_t& b) : pfcp_ie(PFCP_IE_MAC_ADDRESSES_DETECTED){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_mac_addresses_removed_ie(const pfcp::mac_addresses_removed_t& b) : pfcp_ie(PFCP_IE_MAC_ADDRESSES_REMOVED){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_ethernet_inactivity_timer_ie(const pfcp::ethernet_inactivity_timer_t& b) : pfcp_ie(PFCP_IE_ETHERNET_INACTIVITY_TIMER){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_additional_monitoring_time_ie(const pfcp::additional_monitoring_time& b) : pfcp_ie(PFCP_IE_ADDITIONAL_MONITORING_TIME){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_event_information_ie(const pfcp::event_information& b) : pfcp_ie(PFCP_IE_EVENT_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_event_reporting_ie(const pfcp::event_reporting& b) : pfcp_ie(PFCP_IE_EVENT_REPORTING){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_event_threshold_ie(const pfcp::event_threshold_t& b) : pfcp_ie(PFCP_IE_EVENT_THRESHOLD){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_trace_information_ie(const pfcp::trace_information_t& b) : pfcp_ie(PFCP_IE_TRACE_INFORMATION){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_framed_route_ie(const pfcp::framed_route_t& b) : pfcp_ie(PFCP_IE_FRAMED_ROUTE){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_framed_routing_ie(const pfcp::framed_routing_t& b) : pfcp_ie(PFCP_IE_FRAMED_ROUTING){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//
//  //--------
//  pfcp_framed_ipv6_route_ie(const pfcp::framed_ipv6_route_t& b) : pfcp_ie(PFCP_IE_FRAMED_IPV6_ROUTE){
//    todo = 0;
//    tlv.set_length(1);
//  }
//  //--------
...
//// BBF IE Extensions
// IE TRAFFIC_ENDPOINT_ID
class pfcp_pppoe_session_id_ie : public pfcp_ie {
public:
  uint16_t pppoe_session_id;

  //--------
  explicit pfcp_pppoe_session_id_ie(const pfcp::pppoe_session_id_t& b) : pfcp_ie(PFCP_IE_PPPOE_SESSION_ID){
    pppoe_session_id = b.pppoe_session_id;
    tlv.set_enterprise_id(3561);
    tlv.set_length(4);
  }
  //--------
  pfcp_pppoe_session_id_ie() : pfcp_ie(PFCP_IE_PPPOE_SESSION_ID){
    pppoe_session_id = 0;
    tlv.set_enterprise_id(3561);
    tlv.set_length(4);
  }
  //--------
  explicit pfcp_pppoe_session_id_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
  void to_core_type(pfcp::pppoe_session_id_t& b) {
    b.pppoe_session_id = pppoe_session_id;
  }
  //--------
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
    auto ns_pppoe_session_id = htobe16(pppoe_session_id);
    os.write(reinterpret_cast<const char*>(&ns_pppoe_session_id), sizeof(ns_pppoe_session_id));
  }
  //--------
  void load_from(std::istream& is) {
    //tlv.load_from(is);
    ...
    is.read(reinterpret_cast<char*>(&pppoe_session_id), sizeof(pppoe_session_id));
    pppoe_session_id = be16toh(pppoe_session_id);
  }
  //--------
  void to_core_type(pfcp_ies_container& s) {
    pfcp::pppoe_session_id_t pppoe_session_id = {};
    to_core_type(pppoe_session_id);
    s.set(pppoe_session_id);
   }
};

//-------------------------------------
// IE BBF OUTER_HEADER_REMOVAL
class pfcp_bbf_outer_header_removal_ie : public pfcp_ie {
public:
  uint16_t  bbf_outer_header_removal_description;

  //--------
  explicit pfcp_bbf_outer_header_removal_ie(const pfcp::bbf_outer_header_removal_t& b) : pfcp_ie(PFCP_IE_BBF_OUTER_HEADER_REMOVAL){
    bbf_outer_header_removal_description = b.bbf_outer_header_removal_description;
    tlv.set_enterprise_id(3561);
    tlv.set_length(4);
  }
  //--------
  pfcp_bbf_outer_header_removal_ie() : pfcp_ie(PFCP_IE_BBF_OUTER_HEADER_REMOVAL){
    bbf_outer_header_removal_description = 0;
    tlv.set_enterprise_id(3561);
    tlv.set_length(4);
  }
  //--------
  explicit pfcp_bbf_outer_header_removal_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
  void to_core_type(pfcp::bbf_outer_header_removal_t& b) {
    b.bbf_outer_header_removal_description = bbf_outer_header_removal_description;
  }
  //--------
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
    auto ns_bbf_outer_header_removal_description = htobe16(bbf_outer_header_removal_description);
    os.write(reinterpret_cast<const char*>(&ns_bbf_outer_header_removal_description), sizeof(ns_bbf_outer_header_removal_description));
  }
  //--------
  void load_from(std::istream& is) {
    //tlv.load_from(is);
    ...
    is.read(reinterpret_cast<char*>(&bbf_outer_header_removal_description), sizeof(bbf_outer_header_removal_description));
    bbf_outer_header_removal_description = be16toh(bbf_outer_header_removal_description);
  }
  //--------
  void to_core_type(pfcp_ies_container& s) {
    pfcp::bbf_outer_header_removal_t bbf_outer_header_removal = {};
    to_core_type(bbf_outer_header_removal);
    s.set(bbf_outer_header_removal);
  }
};

// IE BBF_OUTER_HEADER_CREATION
class pfcp_bbf_outer_header_creation_ie : public pfcp_ie {
public:
  uint16_t bbf_outer_header_creation_description;
  uint16_t tunnel_id;
  uint16_t session_id;
  //--------
  explicit pfcp_bbf_outer_header_creation_ie(const pfcp::bbf_outer_header_creation_t& b) : pfcp_ie(PFCP_IE_BBF_OUTER_HEADER_CREATION){
    tunnel_id = {};
    session_id = {};

    bbf_outer_header_creation_description = b.bbf_outer_header_creation_description;
    tlv.set_enterprise_id(3561);
    tlv.set_length(4);

    if (bbf_outer_header_creation_description & pfcp::BBF_OUTER_HEADER_CREATION_L2TP) {
      tunnel_id = b.tunnel_id;
      session_id = b.session_id;
      tlv.add_length(sizeof(tunnel_id)+sizeof(session_id));
    }
  }
  //--------
  pfcp_bbf_outer_header_creation_ie() : pfcp_ie(PFCP_IE_BBF_OUTER_HEADER_CREATION){
    bbf_outer_header_creation_description = {};
    tunnel_id = {};
    session_id = {};
    tlv.set_enterprise_id(3561);
    tlv.set_length(2);
  ...
  //--------
  explicit pfcp_bbf_outer_header_creation_ie(const pfcp_tlv& t) : pfcp_ie(t) {
  };
  //--------
  void to_core_type(pfcp::bbf_outer_header_creation_t& b) {
    b.bbf_outer_header_creation_description = bbf_outer_header_creation_description;
    b.tunnel_id = tunnel_id;
  ...
  void dump_to(std::ostream& os) {
    ...
    tlv.dump_to(os);
    auto be_bbf_outer_header_creation_description = htobe16(bbf_outer_header_creation_description);
    os.write(reinterpret_cast<const char*>(&be_bbf_outer_header_creation_description), sizeof(be_bbf_outer_header_creation_description));
    if (bbf_outer_header_creation_description & pfcp::BBF_OUTER_HEADER_CREATION_L2TP) {
      auto be_tunnel_id = htobe16(tunnel_id);
      auto be_session_id = htobe16(session_id);
      os.write(reinterpret_cast<const char*>(&be_tunnel_id), sizeof(be_tunnel_id));
      os.write(reinterpret_cast<const char*>(&be_session_id), sizeof(be_session_id));
    }
  }
  //--------
  void load_from(std::istream& is) {
    ...
    is.read(reinterpret_cast<char*>(&bbf_outer_header_creation_description), sizeof(bbf_outer_header_creation_description));
    bbf_outer_header_creation_description = be16toh(bbf_outer_header_creation_description);
    if (bbf_outer_header_creation_description & pfcp::BBF_OUTER_HEADER_CREATION_L2TP) {
      is.read(reinterpret_cast<char*>(&tunnel_id), sizeof(tunnel_id));
      tunnel_id = be16toh(tunnel_id);
      is.read(reinterpret_cast<char*>(&session_id), sizeof(session_id));
  ...
  void to_core_type(pfcp_ies_container& s) {
      ...
      to_core_type(bbf_outer_header_creation);
      s.set(bbf_outer_header_creation);
  }
};
...
public:
  ...
  explicit pfcp_ethernet_packet_filter_ie(const pfcp::ethernet_packet_filter& b)
    ...
    tlv.set_length(0);
    // if (b.ethernet_filter_id.first) {std::shared_ptr<pfcp_ethernet_filter_id_ie> sie(new pfcp_ethernet_filter_id_ie(b.ethernet_filter_id.second)); add_ie(sie);} // TODO: Implement IE
    // if (b.ethernet_filter_properties.first) {std::shared_ptr<pfcp_ethernet_filter_properties_ie> sie(new pfcp_ethernet_filter_properties_ie(b.ethernet_filter_properties.second)); add_ie(sie);} // TODO: Implement IE
    if (b.mac_address.first) {std::shared_ptr<pfcp_mac_address_ie> sie(new pfcp_mac_address_ie(b.mac_address.second)); add_ie(sie);}
    // if (b.ethertype.first) {std::shared_ptr<pfcp_ethertype_ie> sie(new pfcp_ethertype_ie(b.ethertype.second)); add_ie(sie);} // TODO: Implement IE
    if (b.c_tag.first) {std::shared_ptr<pfcp_c_tag_ie> sie(new pfcp_c_tag_ie(b.c_tag.second)); add_ie(sie);}
    if (b.s_tag.first) {std::shared_ptr<pfcp_s_tag_ie> sie(new pfcp_s_tag_ie(b.s_tag.second)); add_ie(sie);}
...
public:
  ...
  explicit pfcp_pdi_ie(const pfcp::pdi& b) : pfcp_grouped_ie(PFCP_IE_PDI){
    ...
    if (b.ethernet_packet_filter.first) {std::shared_ptr<pfcp_ethernet_packet_filter_ie> sie(new pfcp_ethernet_packet_filter_ie(b.ethernet_packet_filter.second)); add_ie(sie);} // Ricardo: Uncommented this
...
public:
  ...
  //--------
  explicit pfcp_forwarding_parameters_ie(const pfcp::forwarding_parameters& b) : pfcp_grouped_ie(PFCP_IE_FORWARDING_PARAMETERS){
    tlv.set_length(0);
    ...
    if (b.linked_traffic_endpoint_id.first) {std::shared_ptr<pfcp_traffic_endpoint_id_ie> sie(new pfcp_traffic_endpoint_id_ie(b.linked_traffic_endpoint_id.second)); add_ie(sie);}
    //if (b.proxying.first) {std::shared_ptr<pfcp_proxying_ie> sie(new pfcp_proxying_ie(b.proxying.second)); add_ie(sie);}
    // BBF extensions
    if (b.bbf_outer_header_creation.first) {std::shared_ptr<pfcp_bbf_outer_header_creation_ie> sie(new pfcp_bbf_outer_header_creation_ie(b.bbf_outer_header_creation.second)); add_ie(sie);}
  }
  //--------
  pfcp_forwarding_parameters_ie() : pfcp_grouped_ie(PFCP_IE_FORWARDING_PARAMETERS){
  }
  //--------
  explicit pfcp_forwarding_parameters_ie(const pfcp_tlv& t) : pfcp_grouped_ie(t){
  }
  //--------
...
public:
  //--------
  explicit pfcp_duplicating_parameters_ie(const pfcp::duplicating_parameters& b) : pfcp_grouped_ie(PFCP_IE_DUPLICATING_PARAMETERS){
    tlv.set_length(0);
  }
  //--------
  ...
  //--------
  explicit pfcp_duplicating_parameters_ie(const pfcp_tlv& t) : pfcp_grouped_ie(t){
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_create_pdr_ie(const pfcp::create_pdr& b) : pfcp_grouped_ie(PFCP_IE_CREATE_PDR) {
    tlv.set_length(0);
    if (b.pdr_id.first) {std::shared_ptr<pfcp_pdr_id_ie> sie(new pfcp_pdr_id_ie(b.pdr_id.second)); add_ie(sie);}
    ...
    // BBF Extensions
    if (b.bbf_outer_header_removal.first) {std::shared_ptr<pfcp_bbf_outer_header_removal_ie> sie(new pfcp_bbf_outer_header_removal_ie(b.bbf_outer_header_removal.second)); add_ie(sie);}
  }
  //--------
...
public:
  //--------
  explicit pfcp_create_far_ie(const pfcp::create_far& b) : pfcp_grouped_ie(PFCP_IE_CREATE_FAR){
    tlv.set_length(0);
    if (b.far_id.first) {std::shared_ptr<pfcp_far_id_ie> sie(new pfcp_far_id_ie(b.far_id.second)); add_ie(sie);}
...
public:
  ...
  //--------
  explicit pfcp_create_urr_ie(const pfcp::create_urr& b) : pfcp_grouped_ie(PFCP_IE_CREATE_URR){
    tlv.set_length(0);
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_create_qer_ie(const pfcp::create_qer& b) : pfcp_grouped_ie(PFCP_IE_CREATE_QER){
    tlv.set_length(0);
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_created_pdr_ie(const pfcp::created_pdr& b) : pfcp_grouped_ie(PFCP_IE_CREATED_PDR){
    tlv.set_length(0);
    if (b.pdr_id.first) {std::shared_ptr<pfcp_pdr_id_ie> sie(new pfcp_pdr_id_ie(b.pdr_id.second)); add_ie(sie);}
    if (b.local_fteid.first) {std::shared_ptr<pfcp_fteid_ie> sie(new pfcp_fteid_ie(b.local_fteid.second)); add_ie(sie);}
 }
...
public:
  ...
  //--------
  explicit pfcp_update_forwarding_parameters_ie(const pfcp::update_forwarding_parameters& b) :
    ...
    if (b.forwarding_policy.first) {std::shared_ptr<pfcp_forwarding_policy_ie> sie(new pfcp_forwarding_policy_ie(b.forwarding_policy.second)); add_ie(sie);}
    //if (b.header_enrichment.first) {std::shared_ptr<pfcp_header_enrichment_ie> sie(new pfcp_header_enrichment_ie(b.header_enrichment.second)); add_ie(sie);}
    //if (b.pfcpsmreq_flags.first) {std::shared_ptr<pfcp_pfcpsmreq_flags_ie> sie(new pfcp_pfcpsmreq_flags_ie(b.pfcpsmreq_flags.second)); add_ie(sie);}
    if (b.linked_traffic_endpoint_id.first) {std::shared_ptr<pfcp_traffic_endpoint_id_ie> sie(new pfcp_traffic_endpoint_id_ie(b.linked_traffic_endpoint_id.second)); add_ie(sie);}
    // BBF extensions
    if (b.bbf_outer_header_creation.first) {std::shared_ptr<pfcp_bbf_outer_header_creation_ie> sie(new pfcp_bbf_outer_header_creation_ie(b.bbf_outer_header_creation.second)); add_ie(sie);}
  }
  ...
  //--------
  explicit pfcp_update_forwarding_parameters_ie(const pfcp_tlv& t) : pfcp_grouped_ie(t){
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_update_far_ie(const pfcp::update_far& b) : pfcp_grouped_ie(PFCP_IE_UPDATE_FAR){
    tlv.set_length(0);
    std::shared_ptr<pfcp_far_id_ie> sie(new pfcp_far_id_ie(b.far_id));
    add_ie(sie);
    if (b.apply_action.first) {std::shared_ptr<pfcp_apply_action_ie> sie(new pfcp_apply_action_ie(b.apply_action.second)); add_ie(sie);}
    if (b.update_forwarding_parameters.first) {std::shared_ptr<pfcp_update_forwarding_parameters_ie> sie(new pfcp_update_forwarding_parameters_ie(b.update_forwarding_parameters.second)); add_ie(sie);}
    //if (b.update_duplicating_parameters.first) {std::shared_ptr<pfcp_update_duplicating_parameters_ie> sie(new pfcp_update_duplicating_parameters_ie(b.update_duplicating_parameters.second)); add_ie(sie);}
    if (b.bar_id.first) {std::shared_ptr<pfcp_bar_id_ie> sie(new pfcp_bar_id_ie(b.bar_id.second)); add_ie(sie);}
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_update_bar_within_pfcp_session_report_response_ie(const pfcp::update_bar_within_pfcp_session_report_response& b) : pfcp_grouped_ie(PFCP_IE_UPDATE_BAR_WITHIN_PFCP_SESSION_REPORT_RESPONSE){
    tlv.set_length(0);
  }
  //--------
  ...
  //--------
  explicit pfcp_update_bar_within_pfcp_session_report_response_ie(const pfcp_tlv& t) : pfcp_grouped_ie(t){
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_update_urr_ie(const pfcp::update_urr& b) : pfcp_grouped_ie(PFCP_IE_UPDATE_URR){
    tlv.set_length(0);
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_update_qer_ie(const pfcp::update_qer& b) : pfcp_grouped_ie(PFCP_IE_UPDATE_QER){
    tlv.set_length(0);
  }
  //--------
...
//
//  //--------
//  pfcp_update_bar_ie(const pfcp::update_bar& b) : pfcp_grouped_ie(PFCP_IE_UPDATE_BAR){
//    tlv.set_length(0);
//  }
//  //--------
...
public:
  ...
  //--------
  explicit pfcp_remove_pdr_ie(const pfcp::remove_pdr& b) : pfcp_grouped_ie(PFCP_IE_REMOVE_PDR){
    tlv.set_length(0);
    if (b.pdr_id.first) {std::shared_ptr<pfcp_pdr_id_ie> sie(new pfcp_pdr_id_ie(b.pdr_id.second)); add_ie(sie);}
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_remove_far_ie(const pfcp::remove_far& b) : pfcp_grouped_ie(PFCP_IE_REMOVE_FAR){
    tlv.set_length(0);
    if (b.far_id.first) {std::shared_ptr<pfcp_far_id_ie> sie(new pfcp_far_id_ie(b.far_id.second)); add_ie(sie);}
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_remove_urr_ie(const pfcp::remove_urr& b) : pfcp_grouped_ie(PFCP_IE_REMOVE_URR){
    tlv.set_length(0);
  }
  //--------
...
public:
  ...
  //--------
  explicit pfcp_remove_qer_ie(const pfcp::remove_qer& b) : pfcp_grouped_ie(PFCP_IE_REMOVE_QER){
    tlv.set_length(0);
  }
  //--------
...
//
//  //--------
//  pfcp_remove_bar_ie(const pfcp::remove_bar& b) : pfcp_grouped_ie(PFCP_IE_REMOVE_BAR){
//    tlv.set_length(0);
//  }
//  //--------
...
public:
  //--------
  explicit pfcp_create_traffic_endpoint_ie(const pfcp::create_traffic_endpoint& b) : pfcp_grouped_ie(PFCP_IE_CREATE_TRAFFIC_ENDPOINT){
    tlv.set_length(0);
    if (b.traffic_endpoint_id.first) {std::shared_ptr<pfcp_traffic_endpoint_id_ie> sie(new pfcp_traffic_endpoint_id_ie(b.traffic_endpoint_id.second)); add_ie(sie);}  // Implemented now for testing
    if (b.local_fteid.first) {std::shared_ptr<pfcp_fteid_ie> sie(new pfcp_fteid_ie(b.local_fteid.second)); add_ie(sie);}
    if (b.network_instance.first) {std::shared_ptr<pfcp_network_instance_ie> sie(new pfcp_network_instance_ie(b.network_instance.second)); add_ie(sie);}
    if (b.ue_ip_address.first) {std::shared_ptr<pfcp_ue_ip_address_ie> sie(new pfcp_ue_ip_address_ie(b.ue_ip_address.second)); add_ie(sie);}
    //if (b.ethernet_pdu_session_information.first) {std::shared_ptr<pfcp_ethernet_pdu_session_information_ie> sie(new pfcp_ethernet_pdu_session_information_ie(b.ethernet_pdu_session_information.second)); add_ie(sie);}  // Not implemented
    //if (b.framed_route.first) {std::shared_ptr<pfcp_framed_route_ie> sie(new pfcp_framed_route_ie(b.framed_route.second)); add_ie(sie);} // Not implemented
    //if (b.framed_routing.first) {std::shared_ptr<pfcp_framed_routing_ie> sie(new pfcp_framed_routing_ie(b.framed_routing.second)); add_ie(sie);} // Not implemented
    //if (b.framed_ipv6_route.first) {std::shared_ptr<pfcp_framed_ipv6_route_ie> sie(new pfcp_framed_ipv6_route_ie(b.framed_ipv6_route.second)); add_ie(sie);} // Not implemented

    // BBF extensions
    if (b.mac_address.first) {std::shared_ptr<pfcp_mac_address_ie> sie(new pfcp_mac_address_ie(b.mac_address.second)); add_ie(sie);}
    if (b.c_tag.first) {std::shared_ptr<pfcp_c_tag_ie> sie(new pfcp_c_tag_ie(b.c_tag.second)); add_ie(sie);}
    if (b.s_tag.first) {std::shared_ptr<pfcp_s_tag_ie> sie(new pfcp_s_tag_ie(b.s_tag.second)); add_ie(sie);}
    // if (b.logical_port.first) {std::shared_ptr<pfcp_logical_port_ie> sie(new pfcp_logical_port_ie(b.logical_port.second)); add_ie(sie);}
    if (b.pppoe_session_id.first) {std::shared_ptr<pfcp_pppoe_session_id_ie> sie(new pfcp_pppoe_session_id_ie(b.pppoe_session_id.second)); add_ie(sie);}
    // if (b.l2tp.first) {std::shared_ptr<pfcp_l2tp_ie> sie(new pfcp_l2tp_ie(b.l2tp.second)); add_ie(sie);}
  }
  //--------
  pfcp_create_traffic_endpoint_ie() : pfcp_grouped_ie(PFCP_IE_CREATE_TRAFFIC_ENDPOINT){
  }
  //--------
  explicit pfcp_create_traffic_endpoint_ie(const pfcp_tlv& t) : pfcp_grouped_ie(t){
  }
  //--------
