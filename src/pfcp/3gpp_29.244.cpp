...
//      }
//      break;
    case PFCP_IE_CREATE_TRAFFIC_ENDPOINT: { // Ricardo: Uncommenting this
...
//      }
//      break;
    case PFCP_IE_PPPOE_SESSION_ID: {
        pfcp_pppoe_session_id_ie *ie = new pfcp_pppoe_session_id_ie(tlv);
        ie->load_from(is);
        return ie;
      }
      break;
    case PFCP_IE_BBF_OUTER_HEADER_REMOVAL: {
        pfcp_bbf_outer_header_removal_ie *ie = new pfcp_bbf_outer_header_removal_ie(tlv);
        ie->load_from(is);
        return ie;
      }
    case PFCP_IE_BBF_OUTER_HEADER_CREATION: {
        pfcp_bbf_outer_header_creation_ie *ie = new pfcp_bbf_outer_header_creation_ie(tlv);
        ie->load_from(is);
        return ie;
      }
    default:
